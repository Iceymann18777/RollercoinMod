...
.method public static buildDownloadCompletedNotification(Landroid/content/Context;ILjava/lang/String;Landroid/app/PendingIntent;Ljava/lang/String;)Landroid/app/Notification;
    ...
    .line 116
    invoke-static/range {v0 .. v5}, Lcom/google/android/exoplayer2/ui/DownloadNotificationUtil;->newNotificationBuilder(Landroid/content/Context;ILjava/lang/String;Landroid/app/PendingIntent;Ljava/lang/String;I)Landroid/support/v4/app/v$c;

    move-result-object p0

    .line 118
    invoke-virtual {p0}, Landroid/support/v4/app/v$c;->b()Landroid/app/Notification;
...
.method public static buildProgressNotification(Landroid/content/Context;ILjava/lang/String;Landroid/app/PendingIntent;Ljava/lang/String;[Lcom/google/android/exoplayer2/offline/DownloadManager$TaskState;)Landroid/app/Notification;
    ...
    .line 83
    invoke-static/range {v11 .. v16}, Lcom/google/android/exoplayer2/ui/DownloadNotificationUtil;->newNotificationBuilder(Landroid/content/Context;ILjava/lang/String;Landroid/app/PendingIntent;Ljava/lang/String;I)Landroid/support/v4/app/v$c;
    ...
    .line 92
    invoke-virtual {v0, v5, v3, v4}, Landroid/support/v4/app/v$c;->a(IIZ)Landroid/support/v4/app/v$c;

    .line 93
    invoke-virtual {v0, v1}, Landroid/support/v4/app/v$c;->c(Z)Landroid/support/v4/app/v$c;

    .line 94
    invoke-virtual {v0, v2}, Landroid/support/v4/app/v$c;->a(Z)Landroid/support/v4/app/v$c;
...
.method private static newNotificationBuilder(Landroid/content/Context;ILjava/lang/String;Landroid/app/PendingIntent;Ljava/lang/String;I)Landroid/support/v4/app/v$c;
    .locals 1

    .line 151
    new-instance v0, Landroid/support/v4/app/v$c;

    invoke-direct {v0, p0, p2}, Landroid/support/v4/app/v$c;-><init>(Landroid/content/Context;Ljava/lang/String;)V

    .line 152
    invoke-virtual {v0, p1}, Landroid/support/v4/app/v$c;->a(I)Landroid/support/v4/app/v$c;
    ...
    invoke-virtual {p1, p0}, Landroid/support/v4/app/v$c;->a(Ljava/lang/CharSequence;)Landroid/support/v4/app/v$c;

    :cond_0
    if-eqz p3, :cond_1

    .line 157
    invoke-virtual {p1, p3}, Landroid/support/v4/app/v$c;->a(Landroid/app/PendingIntent;)Landroid/support/v4/app/v$c;

    :cond_1
    if-eqz p4, :cond_2

    .line 160
    new-instance p0, Landroid/support/v4/app/v$b;

    invoke-direct {p0}, Landroid/support/v4/app/v$b;-><init>()V

    invoke-virtual {p0, p4}, Landroid/support/v4/app/v$b;->a(Ljava/lang/CharSequence;)Landroid/support/v4/app/v$b;
