...
.field private final notificationManager:Landroid/support/v4/app/y;
...
.method public constructor <init>(Landroid/content/Context;Ljava/lang/String;ILcom/google/android/exoplayer2/ui/PlayerNotificationManager$MediaDescriptionAdapter;Lcom/google/android/exoplayer2/ui/PlayerNotificationManager$CustomActionReceiver;)V
    ...
    .line 367
    invoke-static {p1}, Landroid/support/v4/app/y;->a(Landroid/content/Context;)Landroid/support/v4/app/y;

    move-result-object p2

    iput-object p2, p0, Lcom/google/android/exoplayer2/ui/PlayerNotificationManager;->notificationManager:Landroid/support/v4/app/y;
    ...
    check-cast p1, Landroid/support/v4/app/v$a;

    iget-object p1, p1, Landroid/support/v4/app/v$a;->e:Landroid/app/PendingIntent;
...
.method private static createPlaybackActions(Landroid/content/Context;)Ljava/util/Map;
    ...
    .line 884
    new-instance v3, Landroid/support/v4/app/v$a;
    ...
    invoke-direct {v3, v4, v5, v1}, Landroid/support/v4/app/v$a;-><init>(ILjava/lang/CharSequence;Landroid/app/PendingIntent;)V
    ...
    invoke-direct {v3, v4, v5, p0}, Landroid/support/v4/app/v$a;-><init>(ILjava/lang/CharSequence;Landroid/app/PendingIntent;)V
...
.method private stopNotification()V
    ...
    .line 730
    iget-object v0, p0, Lcom/google/android/exoplayer2/ui/PlayerNotificationManager;->notificationManager:Landroid/support/v4/app/y;
...
.method private updateNotification(Landroid/graphics/Bitmap;)Landroid/app/Notification;
    ...
    invoke-virtual {v0, v1, p1}, Landroid/support/v4/app/y;->a(ILandroid/app/Notification;)V
...
.method protected createNotification(Lcom/google/android/exoplayer2/Player;Landroid/graphics/Bitmap;)Landroid/app/Notification;
    ...
    invoke-direct {v1, v2, v3}, Landroid/support/v4/app/v$c;-><init>(Landroid/content/Context;Ljava/lang/String;)V
    ...
    check-cast v5, Landroid/support/v4/app/v$a;
    ...
    .line 757
    invoke-virtual {v1, v5}, Landroid/support/v4/app/v$c;->a(Landroid/support/v4/app/v$a;)Landroid/support/v4/app/v$c;
    ...
    .line 761
    :cond_2
    new-instance v2, Landroid/support/v4/media/a/a$a;

    invoke-direct {v2}, Landroid/support/v4/media/a/a$a;-><init>()V

    .line 762
    invoke-virtual {v1, v2}, Landroid/support/v4/app/v$c;->a(Landroid/support/v4/app/v$d;)Landroid/support/v4/app/v$c;
    ...
    invoke-virtual {v2, v4}, Landroid/support/v4/media/a/a$a;->a(Landroid/support/v4/media/session/MediaSessionCompat$Token;)Landroid/support/v4/media/a/a$a;
    ...
    invoke-virtual {v2, v4}, Landroid/support/v4/media/a/a$a;->a([I)Landroid/support/v4/media/a/a$a;
    ...
    .line 769
    :goto_2
    invoke-virtual {v2, v0}, Landroid/support/v4/media/a/a$a;->a(Z)Landroid/support/v4/media/a/a$a;
    ...
    invoke-virtual {v1, v0}, Landroid/support/v4/app/v$c;->b(Landroid/app/PendingIntent;)Landroid/support/v4/app/v$c;

    .line 772
    iget-object v0, p0, Lcom/google/android/exoplayer2/ui/PlayerNotificationManager;->stopPendingIntent:Landroid/app/PendingIntent;

    invoke-virtual {v2, v0}, Landroid/support/v4/media/a/a$a;->a(Landroid/app/PendingIntent;)Landroid/support/v4/media/a/a$a;
    ...
    .line 776
    invoke-virtual {v1, v0}, Landroid/support/v4/app/v$c;->f(I)Landroid/support/v4/app/v$c;
    ...
    .line 777
    invoke-virtual {v0, v2}, Landroid/support/v4/app/v$c;->c(Z)Landroid/support/v4/app/v$c;
    ...
    .line 778
    invoke-virtual {v0, v2}, Landroid/support/v4/app/v$c;->d(I)Landroid/support/v4/app/v$c;
    ...
    .line 779
    invoke-virtual {v0, v2}, Landroid/support/v4/app/v$c;->d(Z)Landroid/support/v4/app/v$c;
    ...
    .line 781
    invoke-virtual {v0, v2}, Landroid/support/v4/app/v$c;->e(I)Landroid/support/v4/app/v$c;
    ...
    .line 782
    invoke-virtual {v0, v2}, Landroid/support/v4/app/v$c;->c(I)Landroid/support/v4/app/v$c;
    ...
    .line 783
    invoke-virtual {v0, v2}, Landroid/support/v4/app/v$c;->b(I)Landroid/support/v4/app/v$c;
    ...
    invoke-virtual {v1, v8, v9}, Landroid/support/v4/app/v$c;->a(J)Landroid/support/v4/app/v$c;

    move-result-object v0

    .line 790
    invoke-virtual {v0, v5}, Landroid/support/v4/app/v$c;->a(Z)Landroid/support/v4/app/v$c;

    move-result-object v0

    .line 791
    invoke-virtual {v0, v5}, Landroid/support/v4/app/v$c;->b(Z)Landroid/support/v4/app/v$c;

    goto :goto_3

    .line 793
    :cond_6
    invoke-virtual {v1, v3}, Landroid/support/v4/app/v$c;->a(Z)Landroid/support/v4/app/v$c;

    move-result-object v0

    invoke-virtual {v0, v3}, Landroid/support/v4/app/v$c;->b(Z)Landroid/support/v4/app/v$c;
    ...
    invoke-virtual {v1, v0}, Landroid/support/v4/app/v$c;->a(Ljava/lang/CharSequence;)Landroid/support/v4/app/v$c;
    ...
    invoke-virtual {v1, v0}, Landroid/support/v4/app/v$c;->b(Ljava/lang/CharSequence;)Landroid/support/v4/app/v$c;
    ...
    .line 804
    invoke-virtual {v1, p2}, Landroid/support/v4/app/v$c;->a(Landroid/graphics/Bitmap;)Landroid/support/v4/app/v$c;
    ...
    .line 808
    invoke-virtual {v1, p1}, Landroid/support/v4/app/v$c;->a(Landroid/app/PendingIntent;)Landroid/support/v4/app/v$c;

    .line 810
    :cond_9
    invoke-virtual {v1}, Landroid/support/v4/app/v$c;->b()Landroid/app/Notification;
