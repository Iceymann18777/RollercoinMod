...
.method static a(Landroid/app/Activity;Landroid/app/Dialog;Ljava/lang/String;Landroid/content/DialogInterface$OnCancelListener;)V
    ...
    .line 130
    invoke-virtual {p1, p0, p2}, Lcom/google/android/gms/common/k;->a(Landroid/support/v4/app/j;Ljava/lang/String;)V
...
.method private final a(Landroid/content/Context;ILjava/lang/String;Landroid/app/PendingIntent;)V
    ...
    invoke-direct {v3, p1}, Landroid/support/v4/app/v$c;-><init>(Landroid/content/Context;)V

    const/4 v4, 0x1

    .line 149
    invoke-virtual {v3, v4}, Landroid/support/v4/app/v$c;->f(Z)Landroid/support/v4/app/v$c;

    move-result-object v3

    .line 150
    invoke-virtual {v3, v4}, Landroid/support/v4/app/v$c;->e(Z)Landroid/support/v4/app/v$c;

    move-result-object v3

    .line 151
    invoke-virtual {v3, p3}, Landroid/support/v4/app/v$c;->a(Ljava/lang/CharSequence;)Landroid/support/v4/app/v$c;

    move-result-object p3

    new-instance v3, Landroid/support/v4/app/v$b;

    invoke-direct {v3}, Landroid/support/v4/app/v$b;-><init>()V

    .line 152
    invoke-virtual {v3, v0}, Landroid/support/v4/app/v$b;->a(Ljava/lang/CharSequence;)Landroid/support/v4/app/v$b;

    move-result-object v3

    invoke-virtual {p3, v3}, Landroid/support/v4/app/v$c;->a(Landroid/support/v4/app/v$d;)Landroid/support/v4/app/v$c;
    ...
    invoke-virtual {p3, v0}, Landroid/support/v4/app/v$c;->a(I)Landroid/support/v4/app/v$c;
    ...
    .line 157
    invoke-virtual {v0, v3}, Landroid/support/v4/app/v$c;->c(I)Landroid/support/v4/app/v$c;
    ...
    .line 161
    invoke-virtual {p3, v0, v1, p4}, Landroid/support/v4/app/v$c;->a(ILjava/lang/CharSequence;Landroid/app/PendingIntent;)Landroid/support/v4/app/v$c;

    goto :goto_0

    .line 162
    :cond_3
    invoke-virtual {p3, p4}, Landroid/support/v4/app/v$c;->a(Landroid/app/PendingIntent;)Landroid/support/v4/app/v$c;
    ...
    .line 164
    invoke-virtual {p3, v3}, Landroid/support/v4/app/v$c;->a(I)Landroid/support/v4/app/v$c;
    ...
    invoke-virtual {v3, v1}, Landroid/support/v4/app/v$c;->c(Ljava/lang/CharSequence;)Landroid/support/v4/app/v$c;
    ...
    invoke-virtual {v1, v3, v4}, Landroid/support/v4/app/v$c;->a(J)Landroid/support/v4/app/v$c;

    move-result-object v1

    .line 167
    invoke-virtual {v1, p4}, Landroid/support/v4/app/v$c;->a(Landroid/app/PendingIntent;)Landroid/support/v4/app/v$c;

    move-result-object p4

    .line 168
    invoke-virtual {p4, v0}, Landroid/support/v4/app/v$c;->b(Ljava/lang/CharSequence;)Landroid/support/v4/app/v$c;
    ...
    :cond_6
    :goto_1
    invoke-virtual {p3, p4}, Landroid/support/v4/app/v$c;->a(Ljava/lang/String;)Landroid/support/v4/app/v$c;

    .line 188
    :cond_7
    invoke-virtual {p3}, Landroid/support/v4/app/v$c;->b()Landroid/app/Notification;
