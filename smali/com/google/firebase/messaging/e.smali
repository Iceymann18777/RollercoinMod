...
.method private final d(Landroid/os/Bundle;Ljava/lang/String;)Ljava/lang/String;
    ...
    .line 206
    iget-object v4, p0, Lcom/google/firebase/messaging/e;->b:Landroid/content/Context;
...
.method final c(Landroid/os/Bundle;)Z
    ...
    .line 59
    invoke-direct {v0, v1, v5}, Lcom/google/firebase/messaging/e;->d(Landroid/os/Bundle;Ljava/lang/String;)Ljava/lang/String;
    ...
    .line 60
    invoke-static {v1, v6}, Lcom/google/firebase/messaging/e;->a(Landroid/os/Bundle;Ljava/lang/String;)Ljava/lang/String;
    ...
    .line 64
    invoke-direct {v0, v8}, Lcom/google/firebase/messaging/e;->a(I)Z
    ...
    .line 71
    invoke-direct {v0, v6}, Lcom/google/firebase/messaging/e;->a(I)Z
    ...
    invoke-direct {v0, v6}, Lcom/google/firebase/messaging/e;->a(Ljava/lang/String;)Ljava/lang/Integer;
    ...
    .line 92
    invoke-static {v1, v9}, Lcom/google/firebase/messaging/e;->a(Landroid/os/Bundle;Ljava/lang/String;)Ljava/lang/String;
    ...
    .line 134
    invoke-static {v12, v1}, Lcom/google/firebase/messaging/e;->a(Landroid/content/Intent;Landroid/os/Bundle;)V
    ...
    .line 139
    invoke-static {v11, v13, v12, v9}, Lcom/google/firebase/iid/y;->a(Landroid/content/Context;ILandroid/content/Intent;I)Landroid/app/PendingIntent;
    ...
    .line 147
    invoke-static {v13, v14, v12, v9}, Lcom/google/firebase/iid/y;->a(Landroid/content/Context;ILandroid/content/Intent;I)Landroid/app/PendingIntent;
    ...
    invoke-direct {v4, v12}, Landroid/support/v4/app/v$c;-><init>(Landroid/content/Context;)V

    .line 172
    invoke-virtual {v4, v3}, Landroid/support/v4/app/v$c;->e(Z)Landroid/support/v4/app/v$c;

    move-result-object v4

    invoke-virtual {v4, v8}, Landroid/support/v4/app/v$c;->a(I)Landroid/support/v4/app/v$c;
    ...
    .line 174
    invoke-virtual {v4, v2}, Landroid/support/v4/app/v$c;->a(Ljava/lang/CharSequence;)Landroid/support/v4/app/v$c;
    ...
    .line 176
    invoke-virtual {v4, v5}, Landroid/support/v4/app/v$c;->b(Ljava/lang/CharSequence;)Landroid/support/v4/app/v$c;

    .line 177
    new-instance v2, Landroid/support/v4/app/v$b;

    invoke-direct {v2}, Landroid/support/v4/app/v$b;-><init>()V

    invoke-virtual {v2, v5}, Landroid/support/v4/app/v$b;->a(Ljava/lang/CharSequence;)Landroid/support/v4/app/v$b;

    move-result-object v2

    invoke-virtual {v4, v2}, Landroid/support/v4/app/v$c;->a(Landroid/support/v4/app/v$d;)Landroid/support/v4/app/v$c;
    ...
    invoke-virtual {v4, v2}, Landroid/support/v4/app/v$c;->d(I)Landroid/support/v4/app/v$c;

    :cond_21
    if-eqz v7, :cond_22

    .line 181
    invoke-virtual {v4, v7}, Landroid/support/v4/app/v$c;->a(Landroid/net/Uri;)Landroid/support/v4/app/v$c;

    :cond_22
    if-eqz v11, :cond_23

    .line 183
    invoke-virtual {v4, v11}, Landroid/support/v4/app/v$c;->a(Landroid/app/PendingIntent;)Landroid/support/v4/app/v$c;

    :cond_23
    if-eqz v9, :cond_24

    .line 185
    invoke-virtual {v4, v9}, Landroid/support/v4/app/v$c;->b(Landroid/app/PendingIntent;)Landroid/support/v4/app/v$c;

    :cond_24
    if-eqz v10, :cond_25

    .line 187
    invoke-virtual {v4, v10}, Landroid/support/v4/app/v$c;->a(Ljava/lang/String;)Landroid/support/v4/app/v$c;
    ...
    .line 190
    invoke-static {v1, v4}, Lcom/google/firebase/messaging/e;->a(Landroid/os/Bundle;Ljava/lang/String;)Ljava/lang/String;
    ...
    .line 193
    :cond_26
    iget-object v4, v0, Lcom/google/firebase/messaging/e;->b:Landroid/content/Context;
