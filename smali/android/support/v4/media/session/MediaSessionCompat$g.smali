...
.field private F:Landroid/support/v4/media/j$a;

.field private G:Landroid/support/v4/media/n$a;
...
.field w:Landroid/support/v4/media/n;
...
.method public constructor <init>(Landroid/content/Context;Ljava/lang/String;Landroid/content/ComponentName;Landroid/app/PendingIntent;)V
    ...
    iput-object v1, p0, Landroid/support/v4/media/session/MediaSessionCompat$g;->G:Landroid/support/v4/media/n$a;
...
.method public a(I)V
    ...
    .line 2098
    invoke-virtual {p0}, Landroid/support/v4/media/session/MediaSessionCompat$g;->g()Z
...
.method a(II)V
    ...
    .line 2502
    iget-object p2, p0, Landroid/support/v4/media/session/MediaSessionCompat$g;->w:Landroid/support/v4/media/n;
    ...
    invoke-virtual {p2, p1}, Landroid/support/v4/media/n;->c(I)V
...
.method public a(Landroid/support/v4/media/j$a;)V
    ...
    .line 2440
    :try_start_0
    iput-object p1, p0, Landroid/support/v4/media/session/MediaSessionCompat$g;->F:Landroid/support/v4/media/j$a;
...
.method public a(Landroid/support/v4/media/n;)V
    ...
    .line 2120
    :cond_0
    iget-object v0, p0, Landroid/support/v4/media/session/MediaSessionCompat$g;->w:Landroid/support/v4/media/n;
    ...
    invoke-virtual {v0, v1}, Landroid/support/v4/media/n;->a(Landroid/support/v4/media/n$a;)V
    ...
    .line 2124
    iput-object p1, p0, Landroid/support/v4/media/session/MediaSessionCompat$g;->w:Landroid/support/v4/media/n;
    ...
    iget-object v1, p0, Landroid/support/v4/media/session/MediaSessionCompat$g;->w:Landroid/support/v4/media/n;
    ...
    .line 2130
    iget-object v0, p0, Landroid/support/v4/media/session/MediaSessionCompat$g;->G:Landroid/support/v4/media/n$a;

    invoke-virtual {p1, v0}, Landroid/support/v4/media/n;->a(Landroid/support/v4/media/n$a;)V
...
.method public b()V
    ...
    .line 2160
    invoke-direct {p0}, Landroid/support/v4/media/session/MediaSessionCompat$g;->h()V
...
.method public b(I)V
    ...
    iget v4, p0, Landroid/support/v4/media/session/MediaSessionCompat$g;->v:I
...
.method b(II)V
    ...
    invoke-virtual {p2, p1}, Landroid/support/v4/media/n;->b(I)V
...
.method b(Landroid/support/v4/media/session/PlaybackStateCompat;)V
    ...
    invoke-virtual {p0, p1}, Landroid/support/v4/media/session/MediaSessionCompat$g;->c(I)I
...
.method public f()Landroid/support/v4/media/j$a;
    .locals 2
    ...
    .line 2433
    :try_start_0
    iget-object v1, p0, Landroid/support/v4/media/session/MediaSessionCompat$g;->F:Landroid/support/v4/media/j$a;
