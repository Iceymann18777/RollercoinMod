...
.method private a(Landroid/graphics/drawable/Drawable;)Z
    ...
    .line 196
    iget-object v0, p0, Landroid/support/v7/widget/i;->d:Landroid/support/v7/widget/at;
    ...
    iput-object v0, p0, Landroid/support/v7/widget/i;->d:Landroid/support/v7/widget/at;
    ...
    invoke-static {v1}, Landroid/support/v4/widget/j;->a(Landroid/widget/ImageView;)Landroid/content/res/ColorStateList;
    ...
    invoke-static {v1}, Landroid/support/v4/widget/j;->b(Landroid/widget/ImageView;)Landroid/graphics/PorterDuff$Mode;
    ...
    .line 209
    iput-boolean v2, v0, Landroid/support/v7/widget/at;->c:Z

    .line 210
    iput-object v1, v0, Landroid/support/v7/widget/at;->b:Landroid/graphics/PorterDuff$Mode;

    .line 213
    :cond_2
    iget-boolean v1, v0, Landroid/support/v7/widget/at;->d:Z

    if-nez v1, :cond_4

    iget-boolean v1, v0, Landroid/support/v7/widget/at;->c:Z
    ...
    invoke-static {p1, v0, v1}, Landroid/support/v7/widget/g;->a(Landroid/graphics/drawable/Drawable;Landroid/support/v7/widget/at;[I)V
...
.method private e()Z
    ...
    .line 178
    iget-object v0, p0, Landroid/support/v7/widget/i;->b:Landroid/support/v7/widget/at;
...
.method public a(I)V
    ...
    .line 88
    invoke-static {p1}, Landroid/support/v7/widget/w;->b(Landroid/graphics/drawable/Drawable;)V
    ...
    .line 92
    :cond_1
    iget-object p1, p0, Landroid/support/v7/widget/i;->a:Landroid/widget/ImageView;
...
.method a(Landroid/content/res/ColorStateList;)V
    ...
    .line 110
    iget-object v0, p0, Landroid/support/v7/widget/i;->c:Landroid/support/v7/widget/at;
    ...
    iput-object v0, p0, Landroid/support/v7/widget/i;->c:Landroid/support/v7/widget/at;
    ...
    .line 114
    iget-object p1, p0, Landroid/support/v7/widget/i;->c:Landroid/support/v7/widget/at;

    const/4 v0, 0x1

    iput-boolean v0, p1, Landroid/support/v7/widget/at;->d:Z
...
.method a(Landroid/graphics/PorterDuff$Mode;)V
    ...
    iput-boolean v0, p1, Landroid/support/v7/widget/at;->c:Z
...
.method public a(Landroid/util/AttributeSet;I)V
    ...
    .line 53
    :try_start_0
    iget-object p2, p0, Landroid/support/v7/widget/i;->a:Landroid/widget/ImageView;
    ...
    invoke-virtual {p1, v1, v0}, Landroid/support/v7/widget/av;->g(II)I
    ...
    invoke-static {p2, v1}, Landroid/support/v7/c/a/a;->b(Landroid/content/Context;I)Landroid/graphics/drawable/Drawable;
    ...
    .line 67
    invoke-static {p2}, Landroid/support/v7/widget/w;->b(Landroid/graphics/drawable/Drawable;)V
    ...
    .line 72
    invoke-virtual {p1, v1}, Landroid/support/v7/widget/av;->e(I)Landroid/content/res/ColorStateList;
    ...
    .line 77
    invoke-virtual {p1, v1, v0}, Landroid/support/v7/widget/av;->a(II)I
    ...
    .line 76
    invoke-static {v0, v1}, Landroid/support/v7/widget/w;->a(ILandroid/graphics/PorterDuff$Mode;)Landroid/graphics/PorterDuff$Mode;
...
.method d()V
    ...
    .line 143
    invoke-direct {p0}, Landroid/support/v7/widget/i;->e()Z
    ...
    .line 144
    invoke-direct {p0, v0}, Landroid/support/v7/widget/i;->a(Landroid/graphics/drawable/Drawable;)Z
    ...
    .line 150
    :cond_1
    iget-object v1, p0, Landroid/support/v7/widget/i;->c:Landroid/support/v7/widget/at;
    ...
    .line 153
    :cond_2
    iget-object v1, p0, Landroid/support/v7/widget/i;->b:Landroid/support/v7/widget/at;
