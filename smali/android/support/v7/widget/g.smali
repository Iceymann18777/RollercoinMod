...
.method private a(Landroid/content/Context;IZLandroid/graphics/drawable/Drawable;)Landroid/graphics/drawable/Drawable;
    ...
    sget-object v3, Landroid/support/v7/widget/g;->a:Landroid/graphics/PorterDuff$Mode;

    .line 279
    invoke-static {p3, v0, v3}, Landroid/support/v7/widget/g;->a(Landroid/graphics/drawable/Drawable;ILandroid/graphics/PorterDuff$Mode;)V
    ...
    .line 281
    invoke-static {p3, v0, v2}, Landroid/support/v7/widget/g;->a(Landroid/graphics/drawable/Drawable;ILandroid/graphics/PorterDuff$Mode;)V
    ...
    .line 284
    invoke-static {p1, p3}, Landroid/support/v7/widget/aq;->a(Landroid/content/Context;I)I

    move-result p1

    sget-object p3, Landroid/support/v7/widget/g;->a:Landroid/graphics/PorterDuff$Mode;

    .line 283
    invoke-static {p2, p1, p3}, Landroid/support/v7/widget/g;->a(Landroid/graphics/drawable/Drawable;ILandroid/graphics/PorterDuff$Mode;)V
    ...
    .line 290
    invoke-static {p1, v0}, Landroid/support/v7/widget/aq;->c(Landroid/content/Context;I)I
...
.method private a(Landroid/content/Context;ILandroid/content/res/ColorStateList;)V
    ...
    .line 574
    iget-object v1, p0, Landroid/support/v7/widget/g;->j:Ljava/util/WeakHashMap;
...
.method static a(Landroid/graphics/drawable/Drawable;Landroid/support/v7/widget/at;[I)V
    ...
    iget-object p1, p1, Landroid/support/v7/widget/at;->b:Landroid/graphics/PorterDuff$Mode;
...
.method private a(Ljava/lang/String;Landroid/support/v7/widget/g$d;)V
    ...
    .line 489
    iget-object v0, p0, Landroid/support/v7/widget/g;->k:Landroid/support/v4/e/a;
    ...
    iput-object v0, p0, Landroid/support/v7/widget/g;->k:Landroid/support/v4/e/a;
...
.method private d(Landroid/content/Context;I)Landroid/graphics/drawable/Drawable;
    ...
    .line 309
    iget-object v0, p0, Landroid/support/v7/widget/g;->l:Landroid/support/v4/e/n;
    ...
    iget-object v2, p0, Landroid/support/v7/widget/g;->k:Landroid/support/v4/e/a;
    ...
    iput-object v0, p0, Landroid/support/v7/widget/g;->l:Landroid/support/v4/e/n;
    ...
    .line 361
    iget-object v7, p0, Landroid/support/v7/widget/g;->l:Landroid/support/v4/e/n;

    invoke-virtual {v7, p2, v2}, Landroid/support/v4/e/n;->c(ILjava/lang/Object;)V

    .line 364
    iget-object v7, p0, Landroid/support/v7/widget/g;->k:Landroid/support/v4/e/a;
    ...
    .line 384
    iget-object p1, p0, Landroid/support/v7/widget/g;->l:Landroid/support/v4/e/n;

    const-string v0, "appcompat_skip_skip"

    invoke-virtual {p1, p2, v0}, Landroid/support/v4/e/n;->c(ILjava/lang/Object;)V
...
.method private e(Landroid/content/Context;)Landroid/content/res/ColorStateList;
    ...
    .line 637
    sget-object v6, Landroid/support/v7/widget/aq;->a:[I
    ...
    .line 641
    sget-object v5, Landroid/support/v7/widget/aq;->e:[I
    ...
    invoke-static {p1, v5}, Landroid/support/v7/widget/aq;->a(Landroid/content/Context;I)I
    ...
    .line 646
    sget-object p1, Landroid/support/v7/widget/aq;->h:[I
...
.method private e(Landroid/content/Context;I)Landroid/content/res/ColorStateList;
    ...
    .line 561
    invoke-virtual {p1, p2}, Landroid/support/v4/e/n;->a(I)Ljava/lang/Object;
...
.method private f(Landroid/content/Context;I)Landroid/content/res/ColorStateList;
    ...
    invoke-static {p1, v3}, Landroid/support/v7/widget/aq;->c(Landroid/content/Context;I)I
    ...
    .line 608
    sget-object p1, Landroid/support/v7/widget/aq;->d:[I
    ...
    .line 612
    sget-object p1, Landroid/support/v7/widget/aq;->b:[I
...
.method declared-synchronized a(Landroid/content/Context;IZ)Landroid/graphics/drawable/Drawable;
    ...
    .line 196
    :try_start_0
    invoke-direct {p0, p1}, Landroid/support/v7/widget/g;->f(Landroid/content/Context;)V
...
.method declared-synchronized b(Landroid/content/Context;I)Landroid/content/res/ColorStateList;
    ...
    .line 531
    invoke-direct {p0, p1}, Landroid/support/v7/widget/g;->e(Landroid/content/Context;)Landroid/content/res/ColorStateList;
