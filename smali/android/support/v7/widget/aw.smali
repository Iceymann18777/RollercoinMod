...
.method public constructor <init>(Landroid/support/v7/widget/Toolbar;ZII)V
    ...
    .line 90
    iput p4, p0, Landroid/support/v7/widget/aw;->o:I

    .line 92
    iput p4, p0, Landroid/support/v7/widget/aw;->p:I
    ...
    invoke-static {p1, v0, v1, v2, p4}, Landroid/support/v7/widget/av;->a(Landroid/content/Context;Landroid/util/AttributeSet;[III)Landroid/support/v7/widget/av;
    ...
    invoke-virtual {p1, v0}, Landroid/support/v7/widget/av;->a(I)Landroid/graphics/drawable/Drawable;

    move-result-object v0

    iput-object v0, p0, Landroid/support/v7/widget/aw;->q:Landroid/graphics/drawable/Drawable;
    ...
    invoke-virtual {p1, p2}, Landroid/support/v7/widget/av;->c(I)Ljava/lang/CharSequence;
    ...
    .line 113
    invoke-virtual {p0, p2}, Landroid/support/v7/widget/aw;->b(Ljava/lang/CharSequence;)V
    ...
    .line 118
    invoke-virtual {p0, p2}, Landroid/support/v7/widget/aw;->c(Ljava/lang/CharSequence;)V
    ...
    .line 123
    invoke-virtual {p0, p2}, Landroid/support/v7/widget/aw;->b(Landroid/graphics/drawable/Drawable;)V
    ...
    .line 128
    invoke-virtual {p0, p2}, Landroid/support/v7/widget/aw;->a(Landroid/graphics/drawable/Drawable;)V

    .line 130
    :cond_4
    iget-object p2, p0, Landroid/support/v7/widget/aw;->j:Landroid/graphics/drawable/Drawable;

    if-nez p2, :cond_5

    iget-object p2, p0, Landroid/support/v7/widget/aw;->q:Landroid/graphics/drawable/Drawable;
    ...
    invoke-virtual {p0, p2}, Landroid/support/v7/widget/aw;->c(Landroid/graphics/drawable/Drawable;)V

    .line 133
    :cond_5
    sget p2, Landroid/support/v7/a/a$j;->ActionBar_displayOptions:I

    invoke-virtual {p1, p2, p4}, Landroid/support/v7/widget/av;->a(II)I

    move-result p2

    invoke-virtual {p0, p2}, Landroid/support/v7/widget/aw;->c(I)V

    .line 135
    sget p2, Landroid/support/v7/a/a$j;->ActionBar_customNavigationLayout:I

    invoke-virtual {p1, p2, p4}, Landroid/support/v7/widget/av;->g(II)I
    ...
    invoke-virtual {p0, p2}, Landroid/support/v7/widget/aw;->a(Landroid/view/View;)V
    ...
    invoke-virtual {p1, p2, p4}, Landroid/support/v7/widget/av;->f(II)I
    ...
    .line 147
    iget-object p2, p0, Landroid/support/v7/widget/aw;->a:Landroid/support/v7/widget/Toolbar;
    ...
    invoke-virtual {p1, p2, v0}, Landroid/support/v7/widget/av;->d(II)I
    ...
    invoke-virtual {p1, v1, v0}, Landroid/support/v7/widget/av;->d(II)I
    ...
    .line 172
    iget-object p4, p0, Landroid/support/v7/widget/aw;->a:Landroid/support/v7/widget/Toolbar;
    ...
    .line 175
    :cond_c
    invoke-direct {p0}, Landroid/support/v7/widget/aw;->r()I

    move-result p2

    iput p2, p0, Landroid/support/v7/widget/aw;->e:I
    ...
    .line 179
    invoke-virtual {p0, p3}, Landroid/support/v7/widget/aw;->f(I)V

    .line 180
    iget-object p1, p0, Landroid/support/v7/widget/aw;->a:Landroid/support/v7/widget/Toolbar;
    ...
    new-instance p2, Landroid/support/v7/widget/aw$1;

    invoke-direct {p2, p0}, Landroid/support/v7/widget/aw$1;-><init>(Landroid/support/v7/widget/aw;)V
...
.method private t()V
    ...
    iget-object v1, p0, Landroid/support/v7/widget/aw;->j:Landroid/graphics/drawable/Drawable;
    ...
    :cond_0
    iget-object v1, p0, Landroid/support/v7/widget/aw;->q:Landroid/graphics/drawable/Drawable;
...
# virtual methods
.method public a(IJ)Landroid/support/v4/view/v;
    .locals 2
    ...
    new-instance p3, Landroid/support/v7/widget/aw$2;

    invoke-direct {p3, p0, p1}, Landroid/support/v7/widget/aw$2;-><init>(Landroid/support/v7/widget/aw;I)V
...
.method public a(I)V
    ...
    :goto_0
    invoke-virtual {p0, p1}, Landroid/support/v7/widget/aw;->a(Landroid/graphics/drawable/Drawable;)V
...
.method public a(Landroid/graphics/drawable/Drawable;)V
    ...
    .line 307
    invoke-direct {p0}, Landroid/support/v7/widget/aw;->s()V
...
.method public a(Landroid/view/View;)V
    ...
    .line 544
    iget p1, p0, Landroid/support/v7/widget/aw;->e:I
...
.method public b(I)V
    ...
    :goto_0
    invoke-virtual {p0, p1}, Landroid/support/v7/widget/aw;->b(Landroid/graphics/drawable/Drawable;)V
...
.method public d(I)V
    ...
    :goto_0
    invoke-virtual {p0, p1}, Landroid/support/v7/widget/aw;->c(Landroid/graphics/drawable/Drawable;)V
...
.method public f(I)V
    ...
    .line 201
    iget p1, p0, Landroid/support/v7/widget/aw;->p:I
...
.method public g(I)V
    ...
    :goto_0
    invoke-virtual {p0, p1}, Landroid/support/v7/widget/aw;->d(Ljava/lang/CharSequence;)V
