...
.method private a(Landroid/support/v7/widget/RecyclerView;IJ)Landroid/support/v7/widget/RecyclerView$v;
    ...
    .line 290
    invoke-virtual {p2}, Landroid/support/v7/widget/RecyclerView$v;->p()Z

    move-result p3

    if-eqz p3, :cond_1

    invoke-virtual {p2}, Landroid/support/v7/widget/RecyclerView$v;->n()Z
    ...
    .line 293
    iget-object p3, p2, Landroid/support/v7/widget/RecyclerView$v;->f:Landroid/view/View;
...
.method private a()V
    ...
    .line 220
    iget-object v5, v4, Landroid/support/v7/widget/RecyclerView;->C:Landroid/support/v7/widget/ab$a;

    invoke-virtual {v5, v4, v1}, Landroid/support/v7/widget/ab$a;->a(Landroid/support/v7/widget/RecyclerView;Z)V
    ...
    .line 251
    iput-object v4, v8, Landroid/support/v7/widget/ab$b;->d:Landroid/support/v7/widget/RecyclerView;
...
.method private a(Landroid/support/v7/widget/RecyclerView;J)V
    ...
    .line 322
    :cond_1
    iget-object v0, p1, Landroid/support/v7/widget/RecyclerView;->C:Landroid/support/v7/widget/ab$a;

    const/4 v1, 0x1

    .line 323
    invoke-virtual {v0, p1, v1}, Landroid/support/v7/widget/ab$a;->a(Landroid/support/v7/widget/RecyclerView;Z)V
...
.method private a(Landroid/support/v7/widget/ab$b;J)V
    ...
    invoke-direct {p0, v2, p1, v0, v1}, Landroid/support/v7/widget/ab;->a(Landroid/support/v7/widget/RecyclerView;IJ)Landroid/support/v7/widget/RecyclerView$v;
    ...
    .line 345
    iget-object v0, p1, Landroid/support/v7/widget/RecyclerView$v;->g:Ljava/lang/ref/WeakReference;
    ...
    .line 349
    iget-object p1, p1, Landroid/support/v7/widget/RecyclerView$v;->g:Ljava/lang/ref/WeakReference;
    ...
    invoke-direct {p0, p1, p2, p3}, Landroid/support/v7/widget/ab;->a(Landroid/support/v7/widget/RecyclerView;J)V
...
.method private b(J)V
    ...
    .line 356
    iget-object v2, v1, Landroid/support/v7/widget/ab$b;->d:Landroid/support/v7/widget/RecyclerView;
...
.method a(Landroid/support/v7/widget/RecyclerView;II)V
    ...
    .line 185
    :cond_0
    iget-object p1, p1, Landroid/support/v7/widget/RecyclerView;->C:Landroid/support/v7/widget/ab$a;
