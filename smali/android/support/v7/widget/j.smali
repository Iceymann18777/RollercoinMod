...
.method private a(Landroid/graphics/drawable/Drawable;)Landroid/graphics/drawable/Drawable;
    ...
    invoke-direct {p0, v4, v5}, Landroid/support/v7/widget/j;->a(Landroid/graphics/drawable/Drawable;Z)Landroid/graphics/drawable/Drawable;
...
.method private a(Landroid/graphics/drawable/Drawable;Z)Landroid/graphics/drawable/Drawable;
    ...
    .line 76
    invoke-direct {p0, v1, p2}, Landroid/support/v7/widget/j;->a(Landroid/graphics/drawable/Drawable;Z)Landroid/graphics/drawable/Drawable;
    ...
    :goto_2
    invoke-direct {p0, v5, v4}, Landroid/support/v7/widget/j;->a(Landroid/graphics/drawable/Drawable;Z)Landroid/graphics/drawable/Drawable;
    ...
    .line 100
    iget-object v2, p0, Landroid/support/v7/widget/j;->c:Landroid/graphics/Bitmap;
...
.method a(Landroid/util/AttributeSet;I)V
    ...
    .line 55
    invoke-virtual {p1, v2}, Landroid/support/v7/widget/av;->b(I)Landroid/graphics/drawable/Drawable;
    ...
    invoke-direct {p0, p2}, Landroid/support/v7/widget/j;->a(Landroid/graphics/drawable/Drawable;)Landroid/graphics/drawable/Drawable;
    ...
    invoke-direct {p0, p2, v2}, Landroid/support/v7/widget/j;->a(Landroid/graphics/drawable/Drawable;Z)Landroid/graphics/drawable/Drawable;
