...
.method constructor <init>(Landroid/support/v7/widget/s$b;)V
    ...
    .line 50
    new-instance p1, Landroid/support/v7/widget/s$a;

    invoke-direct {p1}, Landroid/support/v7/widget/s$a;-><init>()V

    iput-object p1, p0, Landroid/support/v7/widget/s;->b:Landroid/support/v7/widget/s$a;
    ...
    iput-object p1, p0, Landroid/support/v7/widget/s;->c:Ljava/util/List;
...
.method private f(I)I
    ...
    invoke-interface {v1}, Landroid/support/v7/widget/s$b;->a()I
    ...
    invoke-virtual {v3, v2}, Landroid/support/v7/widget/s$a;->e(I)I
    ...
    .line 123
    :goto_1
    iget-object p1, p0, Landroid/support/v7/widget/s;->b:Landroid/support/v7/widget/s$a;

    invoke-virtual {p1, v2}, Landroid/support/v7/widget/s$a;->c(I)Z
...
.method a()V
    ...
    iget-object v2, p0, Landroid/support/v7/widget/s;->c:Ljava/util/List;
    ...
    invoke-interface {v1, v2}, Landroid/support/v7/widget/s$b;->d(Landroid/view/View;)V
...
.method a(I)V
    ...
    .line 166
    invoke-direct {p0, v0}, Landroid/support/v7/widget/s;->h(Landroid/view/View;)Z

    .line 168
    :cond_1
    iget-object v0, p0, Landroid/support/v7/widget/s;->a:Landroid/support/v7/widget/s$b;

    invoke-interface {v0, p1}, Landroid/support/v7/widget/s$b;->a(I)V
...
.method a(Landroid/view/View;)V
    ...
    .line 147
    :cond_1
    iget-object p1, p0, Landroid/support/v7/widget/s;->a:Landroid/support/v7/widget/s$b;

    invoke-interface {p1, v0}, Landroid/support/v7/widget/s$b;->a(I)V
...
.method a(Landroid/view/View;ILandroid/view/ViewGroup$LayoutParams;Z)V
    ...
    .line 231
    iget-object p2, p0, Landroid/support/v7/widget/s;->a:Landroid/support/v7/widget/s$b;

    invoke-interface {p2}, Landroid/support/v7/widget/s$b;->a()I
    ...
    invoke-virtual {v0, p2, p4}, Landroid/support/v7/widget/s$a;->a(IZ)V
    ...
    .line 239
    :cond_1
    iget-object p4, p0, Landroid/support/v7/widget/s;->a:Landroid/support/v7/widget/s$b;

    invoke-interface {p4, p1, p2, p3}, Landroid/support/v7/widget/s$b;->a(Landroid/view/View;ILandroid/view/ViewGroup$LayoutParams;)V
...
.method a(Landroid/view/View;IZ)V
    ...
    invoke-virtual {v0, p2, p3}, Landroid/support/v7/widget/s$a;->a(IZ)V
    ...
    .line 107
    :cond_1
    iget-object p3, p0, Landroid/support/v7/widget/s;->a:Landroid/support/v7/widget/s$b;

    invoke-interface {p3, p1, p2}, Landroid/support/v7/widget/s$b;->a(Landroid/view/View;I)V
...
.method c(I)Landroid/view/View;
    ...
    invoke-interface {v3, v2}, Landroid/support/v7/widget/s$b;->b(Landroid/view/View;)Landroid/support/v7/widget/RecyclerView$v;
...
.method e(I)V
    ...
    invoke-virtual {v0, p1}, Landroid/support/v7/widget/s$a;->d(I)Z

    .line 284
    iget-object v0, p0, Landroid/support/v7/widget/s;->a:Landroid/support/v7/widget/s$b;

    invoke-interface {v0, p1}, Landroid/support/v7/widget/s$b;->c(I)V
...
.method f(Landroid/view/View;)Z
    ...
    invoke-virtual {v2, v0}, Landroid/support/v7/widget/s$a;->c(I)Z
