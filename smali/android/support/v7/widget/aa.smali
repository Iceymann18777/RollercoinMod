...
.method public constructor <init>(Landroid/view/View;)V
    ...
    iput-object v1, p0, Landroid/support/v7/widget/aa;->i:[I
    ...
    iput p1, p0, Landroid/support/v7/widget/aa;->a:F
    ...
    .line 77
    iget p1, p0, Landroid/support/v7/widget/aa;->b:I
...
.method private a(Landroid/view/MotionEvent;)Z
    ...
    .line 191
    :pswitch_0
    iget v1, p0, Landroid/support/v7/widget/aa;->h:I
    ...
    invoke-static {v0, v3, p1, v1}, Landroid/support/v7/widget/aa;->a(Landroid/view/View;FFF)Z
    ...
    .line 180
    iget-object p1, p0, Landroid/support/v7/widget/aa;->e:Ljava/lang/Runnable;

    if-nez p1, :cond_1

    .line 181
    new-instance p1, Landroid/support/v7/widget/aa$a;

    invoke-direct {p1, p0}, Landroid/support/v7/widget/aa$a;-><init>(Landroid/support/v7/widget/aa;)V

    iput-object p1, p0, Landroid/support/v7/widget/aa;->e:Ljava/lang/Runnable;
    ...
    .line 185
    iget-object p1, p0, Landroid/support/v7/widget/aa;->f:Ljava/lang/Runnable;

    if-nez p1, :cond_2

    .line 186
    new-instance p1, Landroid/support/v7/widget/aa$b;

    invoke-direct {p1, p0}, Landroid/support/v7/widget/aa$b;-><init>(Landroid/support/v7/widget/aa;)V

    iput-object p1, p0, Landroid/support/v7/widget/aa;->f:Ljava/lang/Runnable;
...
.method private b(Landroid/view/MotionEvent;)Z
    ...
    .line 260
    invoke-virtual {p0}, Landroid/support/v7/widget/aa;->a()Landroid/support/v7/view/menu/s;
    ...
    .line 266
    invoke-virtual {v1}, Landroid/support/v7/widget/x;->isShown()Z
    ...
    .line 272
    invoke-direct {p0, v0, v3}, Landroid/support/v7/widget/aa;->b(Landroid/view/View;Landroid/view/MotionEvent;)Z

    .line 273
    invoke-direct {p0, v1, v3}, Landroid/support/v7/widget/aa;->a(Landroid/view/View;Landroid/view/MotionEvent;)Z

    .line 276
    iget v0, p0, Landroid/support/v7/widget/aa;->h:I

    invoke-virtual {v1, v3, v0}, Landroid/support/v7/widget/x;->a(Landroid/view/MotionEvent;I)Z
...
.method d()V
    ...
    .line 248
    iput-boolean v2, p0, Landroid/support/v7/widget/aa;->g:Z
...
.method public onTouch(Landroid/view/View;Landroid/view/MotionEvent;)Z
    ...
    .line 94
    iget-boolean p1, p0, Landroid/support/v7/widget/aa;->g:Z
    ...
    :cond_4
    :goto_2
    iput-boolean p2, p0, Landroid/support/v7/widget/aa;->g:Z
...
.method public onViewDetachedFromWindow(Landroid/view/View;)V
    ...
    .line 121
    iput-boolean p1, p0, Landroid/support/v7/widget/aa;->g:Z
    ...
    .line 125
    iget-object p1, p0, Landroid/support/v7/widget/aa;->c:Landroid/view/View;
