...
.method public a()V
    ...
    .line 139
    iget-object v0, p0, Landroid/support/v7/view/menu/i;->c:Landroid/support/v7/app/a;
...
.method public a(Landroid/os/IBinder;)V
    ...
    invoke-virtual {v1}, Landroid/support/v7/app/a$a;->a()Landroid/content/Context;
    ...
    invoke-virtual {v1, v2, p0}, Landroid/support/v7/app/a$a;->a(Landroid/widget/ListAdapter;Landroid/content/DialogInterface$OnClickListener;)Landroid/support/v7/app/a$a;
    ...
    .line 69
    invoke-virtual {v1, v2}, Landroid/support/v7/app/a$a;->a(Landroid/view/View;)Landroid/support/v7/app/a$a;
    ...
    invoke-virtual {v1, v2}, Landroid/support/v7/app/a$a;->a(Landroid/graphics/drawable/Drawable;)Landroid/support/v7/app/a$a;
    ...
    invoke-virtual {v2, v0}, Landroid/support/v7/app/a$a;->a(Ljava/lang/CharSequence;)Landroid/support/v7/app/a$a;

    .line 76
    :goto_0
    invoke-virtual {v1, p0}, Landroid/support/v7/app/a$a;->a(Landroid/content/DialogInterface$OnKeyListener;)Landroid/support/v7/app/a$a;
    ...
    iput-object v0, p0, Landroid/support/v7/view/menu/i;->c:Landroid/support/v7/app/a;

    .line 80
    iget-object v0, p0, Landroid/support/v7/view/menu/i;->c:Landroid/support/v7/app/a;

    invoke-virtual {v0, p0}, Landroid/support/v7/app/a;->setOnDismissListener(Landroid/content/DialogInterface$OnDismissListener;)V

    .line 82
    iget-object v0, p0, Landroid/support/v7/view/menu/i;->c:Landroid/support/v7/app/a;

    invoke-virtual {v0}, Landroid/support/v7/app/a;->getWindow()Landroid/view/Window;
    ...
    .line 89
    iget-object p1, p0, Landroid/support/v7/view/menu/i;->c:Landroid/support/v7/app/a;
...
.method public onKey(Landroid/content/DialogInterface;ILandroid/view/KeyEvent;)Z
    ...
    invoke-virtual {p1}, Landroid/support/v7/app/a;->getWindow()Landroid/view/Window;
